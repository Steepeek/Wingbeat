...
- **Добыча за сессию** строкой внизу: опыт, AP, кинах, убитые мобы,
  PvP-убийства, смерти. Отдельное окно «Добыча» (меню) показывает, кто из
  группы что подобрал, с названиями предметов и цветом качества, и какие
  были броски кубика.
...
**Вкладки** слева переключают, что считать: урон, хил или полученный урон.
Под ними — строка заголовков колонок.
