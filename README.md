...
**Иконок скиллов не будет.** Они лежат в `Textures/ui/ui.pak`, а он на
приватных серверах зашифрован (`OADTENC1`); у паков с сигнатурой
`AF B4 FC FB` — это ZIP с инвертированными сигнатурами — зашифровано
содержимое файлов. Тянуть их со сторонних сайтов тоже не вариант: тот же
AionCodex закрыт JS-защитой от ботов и помечен `noindex, noarchive`.
