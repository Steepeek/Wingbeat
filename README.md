...
приватных серверах зашифрован (`OADTENC1`); у остальных паков зашифровано
содержимое файлов. Плюс это art NCSoft — раздавать его вместе с программой
нельзя. Вместо иконок используется цвет класса: так делают и Details!, и
Skada, и читается это не хуже.
